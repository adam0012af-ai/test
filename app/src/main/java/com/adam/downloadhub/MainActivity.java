...
public class MainActivity extends Activity {
    ...
    private View buildUi(){
        ...
        LinearLayout header=new LinearLayout(this);header.setOrientation(LinearLayout.HORIZONTAL);header.setGravity(Gravity.CENTER_VERTICAL);ImageView logo=new ImageView(this);logo.setImageResource(R.mipmap.ic_launcher);logo.setScaleType(ImageView.ScaleType.FIT_CENTER);header.addView(logo,new LinearLayout.LayoutParams(Ui.dp(this,54),Ui.dp(this,54)));LinearLayout brand=new LinearLayout(this);brand.setOrientation(LinearLayout.VERTICAL);brand.addView(Ui.text(this,"Download Hub",24,Ui.TEXT,true));brand.addView(Ui.text(this,"MEDIA • CREATOR • TIKTOK",10,Ui.CYAN,true));brand.addView(Ui.text(this,"AboAdam",10,Ui.MUTED,false));LinearLayout.LayoutParams br=new LinearLayout.LayoutParams(0,ViewGroup.LayoutParams.WRAP_CONTENT,1f);br.setMargins(Ui.dp(this,10),0,0,0);header.addView(brand,br);Button settings=Ui.ghost(this,"⚙");settings.setTextSize(18);settings.setOnClickListener(v->startActivity(new Intent(this,SettingsActivity.class)));header.addView(settings,new LinearLayout.LayoutParams(Ui.dp(this,48),Ui.dp(this,46)));root.addView(header);

        LinearLayout creator=Ui.card(this);LinearLayout.LayoutParams cr=Ui.matchWrap();cr.setMargins(0,Ui.dp(this,14),0,0);creator.setLayoutParams(cr);creator.setBackground(Ui.gradient3(0xFF0C4D9B,0xFF143462,0xFF0A1B32,24,this));creator.addView(Ui.text(this,"حمّل • اعمل مونتاج • انشر على TikTok",22,Ui.TEXT,true));TextView hs=Ui.text(this,"أزرار مباشرة وواضحة للتجربة السريعة: تحميل، مونتاج فيديو فعلي، وريـلز إسلامي.",12,0xFFC9DDF6,false);hs.setLineSpacing(0,1.25f);LinearLayout.LayoutParams hsp=Ui.matchWrap();hsp.setMargins(0,Ui.dp(this,7),0,Ui.dp(this,13));creator.addView(hs,hsp);
        LinearLayout hr=new LinearLayout(this);hr.setOrientation(LinearLayout.HORIZONTAL);
        Button homeDownload=Ui.accent(this,"↓  تحميل");homeDownload.setTextSize(16);homeDownload.setOnClickListener(v->{scroll.post(()->scroll.smoothScrollTo(0,Ui.dp(this,410)));if(smartUrl!=null)smartUrl.requestFocus();});hr.addView(homeDownload,new LinearLayout.LayoutParams(0,Ui.dp(this,58),1f));
        Button montage=Ui.primary(this,"✂  مونتاج فيديو");montage.setOnClickListener(v->{Intent i=new Intent(this,TemplateEditorActivity.class);i.putExtra("template_id","islamic-0");i.putExtra("pick_media",true);startActivity(i);});LinearLayout.LayoutParams ml=new LinearLayout.LayoutParams(0,Ui.dp(this,58),1f);ml.setMargins(Ui.dp(this,8),0,0,0);hr.addView(montage,ml);creator.addView(hr);
        Button islamic=Ui.secondary(this,"☾  مكتبة الريلز الإسلامي");islamic.setOnClickListener(v->{Intent i=new Intent(this,TemplateLibraryActivity.class);i.putExtra("category","islamic");startActivity(i);});LinearLayout.LayoutParams isl=Ui.matchWrap();isl.height=Ui.dp(this,52);isl.setMargins(0,Ui.dp(this,8),0,0);creator.addView(islamic,isl);root.addView(creator);
